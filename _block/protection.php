<section>
    <div class="row protection">
        ...
        <div class="col-xl-3 col-md-12">
            <div class="row">
                <div class="col-xl-12 col-6 icons_v">
                    <a class="link-wrapper" href="#">
                        <div class="icon-v wow slideInRight">
                            <img class="icon_image" src="../img/icons/i_05.svg" alt="">
                ...
                <div class="col-xl-12 col-6">
                    <a class="link-wrapper" href="#">
                        <div class="icon-v wow slideInRight">
                            <img class="icon_image" src="../img/icons/i_08.svg" alt="">
        ...
        <div class="col-xl-7 col-md-12">
            <div class="row">
                <div class="col-xl-6 col-6">
                    <a class="link-wrapper" href="#">
                        <div class="icon-h  wow slideInLeft">
                            <img class="icon_image" src="../img/icons/i_07.svg" alt="">
                ...
                <div class="col-xl-6 col-6">
                    <a class="link-wrapper" href="#">
                        <div class="icon-h  wow slideInLeft">
                            <img class="icon_image" src="../img/icons/i_06.svg" alt="">
